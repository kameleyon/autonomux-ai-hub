    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 bg-background">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            <h1 className="text-2xl font-medium font-display">Create your account</h1>
            <p className="text-sm text-muted-foreground mt-1">Start automating with 25 free credits</p>
          </div>
        </CardHeader>
        <CardContent>
